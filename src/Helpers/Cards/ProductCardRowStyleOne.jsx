...
export default function ProductCardRowStyleTwo({ className, datas, type }) {
  return (
    ...
    >
      <div className="flex space-x-5 items-center w-full h-full lg:p-[30px] sm:p-5 p-2" style={{ borderRadius: "30px" }} style={{ borderRadius: "30px" }}>
        <div className="lg:w-1/2 w-1/3 h-full" style={{ borderRadius: "30px" }}>
          <img
        ...
        <div className="flex-1 flex flex-col justify-center h-full" >
          <div >
            ...
            <button type="button" className="w-[110px] h-[30px]" >
              <span className={type === 3 ? 'blue-btn' : 'yellow-btn'} style={{ borderRadius: "10px" }}> Add To Cart</span>
            </button>
          </div>
        </div>
      </div>
