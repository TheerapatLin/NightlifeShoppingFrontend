...
const ProfilePage = ({ onClose }) => {
  ...
  return (
    <div style={{
      ...
      <div className={`popup-right ${showPopup ? '' : 'slideOut'}`} style={{ display: 'block', maxWidth: '100%' }}>
        <div style={{ fontStyle: "normal", display: "flex", alignItems: "center", marginInline: 20 }}>
          <p style={{ color: "#31ff64", fontSize: 25, fontWeight: "bold" }}>Profile Page</p>
          <i
            className="bi bi-x"
        ...
        <div className="popup-container" style={{ position: 'relative', top: '-200px', marginBottom: '-180px', display: 'flex', flexDirection: 'column' }}>
          <div className="photo-profile" style={{marginBottom:'-80px', position:'relative', zIndex:'999'}}>
            {user && (<img
              src={user.profileImage}
              alt="Profile"
          ...
          <div className="popup-content Profile" style={{background: 'rgba(206, 206, 206, 0.5)' }}>
            <div className="profile-username" style={{ flex: 1, overflow: 'auto',padding: 'inherit',marginBottom: '20px', marginTop: '50px'}}>
              {user && (
                <div style={{}}>
            ...
            <div style={{ flex: 1, overflow: 'auto',padding: 'inherit', backgroundColor: 'rgb(43,43,43)', borderRadius:'100px', display:'flex', justifyContent: 'space-around', boxShadow: 'rgb(5 5 38) 0px 30px 60px -12px inset, rgb(0 0 0 / 63%) 0px 18px 36px -18px inset',marginBlock:20}}>
              <div>
            ...
            <div style={{ flex: 1, overflow: 'auto',padding: 'inherit', backgroundColor: 'rgb(43,43,43)', borderRadius:'100px', display:'flex', justifyContent: 'space-around', boxShadow: 'rgb(5, 5, 38) 0px -20px 60px -12px inset, rgba(0, 0, 0, 0.63) 0px -20px 36px -18px inset'}}>
              <div style={{}}>
                <h3 style={{color:'#fff'}}>Coin</h3>
                {user && (
                  <div style={{}}>
                    <h3 style={{color:'#E2346E'}}><img src={imgCoin} style={{width:15}}/>{' '}{user.myCoin.total}</h3>
                  </div>
                )}
              </div>
              <div>
                ...
                {user && (
                  <div style={{}}>
                    <h3 style={{color:'#E2346E'}}><img src={imgChampagne} style={{width:15}}/>{' '}{user.myPoint}</h3>
                  </div>
                )}
              </div>
            </div>
            <div style={{display:'flex', alignItems: 'baseline', justifyContent:'space-between', marginTop:20, padding: 'inherit'}}>
          ...
          <div className="popup-content Manage-profile" style={{ flex: 1, overflow: 'auto',padding: 'inherit',background: 'rgba(206, 206, 206, 0.5)' }}>
            <div>
              <h3 style={{ backgroundColor: '#E2346E', color: '#FFF', borderRadius: '10px 10px 0 0', display:'flex', justifyContent:'start',flexGrow: 1, paddingBlock:10, borderBottom: 'none'}}>
                <Link to="/ManageProfile" onClick={handleClose} className={`${location.pathname === "/ManageProfile" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>  
                  <i className="bi bi-person-fill" style={{marginInline:20, fontStyle:'normal'}}>{' '}Manage Profile</i>
                </Link>
              </h3>
              <h3 style={{display:'flex', justifyContent:'start', paddingBlock:10, color:'#fff'}}>
                <Link to="/MyPurchase" onClick={handleClose} className={`${location.pathname === "/MyPurchase" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>
                  <i className="bi bi-handbag-fill" style={{marginInline:20, fontStyle:'normal'}}>{' '}MY PURCHASE</i>
                </Link>
              </h3>
              <h3 style={{display:'flex', justifyContent:'start', paddingBlock:10, color:'#fff'}}>
                <Link to="/MyTicket" onClick={handleClose} className={`${location.pathname === "/MyTicket" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>
                  <i className="bi bi-ticket-detailed-fill" style={{marginInline:20, fontStyle:'normal'}}>{' '}MY TICKET</i>
                </Link>
              </h3>
              <h3 style={{display:'flex', justifyContent:'start', paddingBlock:10, color:'#fff'}}>
                <Link to="/MyVoucher" onClick={handleClose} className={`${location.pathname === "/MyVoucher" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>
                  <i className="bi bi-ticket-perforated-fill" style={{marginInline:20, fontStyle:'normal'}}>{' '}MY VOUCHER</i>
                </Link>
              </h3>
              <h3 style={{display:'flex', justifyContent:'start', paddingBlock:10, color:'#fff'}}>
                <Link to="/MyBooking" onClick={handleClose} className={`${location.pathname === "/MyBooking" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>
                  <i className="bi bi-journal-bookmark" style={{marginInline:20, fontStyle:'normal'}}>{' '}MY BOOKING</i>
                </Link>
              </h3>
              <h3 style={{display:'flex', justifyContent:'start', paddingBlock:10, color:'#fff', borderBottom: 'none'}}>
                <Link to="/MyCoin" onClick={handleClose} className={`${location.pathname === "/MyCoin" ? "active" : ""}`} style={{ width:'100%', display:'flex',alignItems:'start' }}>
                  <i className="bi bi-coin" style={{marginInline:20, fontStyle:'normal'}}>{' '}MY COIN</i>
                </Link>
              </h3>
            </div>
          </div>
          <div className="popup-content My-Venues" style={{ flex: 1, overflow: 'auto', padding: 'inherit', background: 'rgba(206, 206, 206, 0.5)', display: 'flex', flexDirection: 'column'}}>
          ...
          <div className="popup-content My-Event" style={{ flex: 1, overflow: 'auto', padding: 'inherit', background: 'rgba(206, 206, 206, 0.5)', display: 'flex', flexDirection: 'column'}}>
            <div style={{ display: 'flex', alignItems: 'center', backgroundColor: '#2B2B2B'}}>
              <h3 style={{ color: '#FFF', borderRadius: '10px 10px 0 0', display: 'flex', justifyContent: 'start', flexGrow: 1, paddingBlock: 10, borderBottom: 'none' }}>
          ...
          <div className="popup-content My-Deal" style={{ flex: 1, overflow: 'auto', padding: 'inherit', background: 'rgba(206, 206, 206, 0.5)', display: 'flex', flexDirection: 'column'}}>
            <div style={{ display: 'flex', alignItems: 'center', backgroundColor: '#2B2B2B' }}>
              <h3 style={{ color: '#FFF', borderRadius: '10px 10px 0 0', display: 'flex', justifyContent: 'start', flexGrow: 1, paddingBlock: 10, borderBottom: 'none' }}>
          ...
          <div className="popup-content About-Us" style={{ flex: 1, overflow: 'auto',padding: 'inherit',background: 'rgba(206, 206, 206, 0.5)' }}>
            <div>
          ...
          <div className="popup-content LOG-OUT" style={{ flex: 1, overflow: 'auto',padding: 'inherit',background: 'rgba(206, 206, 206, 0.5)' }}>
            <div>
