...
import InfoVenues from "./info_venues";
...
function Venues() {
  ...
  const handleSearch = () => {
    ...
    const results = venueData.filter((event) =>
  ...
  return (
    <div>
      <div className="container" style={{ paddingTop: "70px", maxWidth: "90%" }}>
        ...
        >
          <div className="EventSlideHeaderText1">Popular Venues</div>
      ...
      <div className="container" style={{ paddingTop: "70px", maxWidth: "90%" }}>
        <div
          style={{ width: "100%", display: "flex", flexDirection: "row", alignItems: "end", justifyContent: "center" }}
        >
      ...
      <EventSlider3
        ...
        detailElement={(data, index) => (
          <div>
            ...
            {/* <p className="item03" style={{ color: "#31ff64", padding: "0px 0px 0px 20px", fontSize: "12px" }}>
              <i className="bi bi-star-fill"></i> {data?.popularity ?? ""}
            </p> */}
            <p className="item03" style={{ color: "#FFFF00", padding: "0px 0px 15px 20px", fontSize: "16px" }}>
              {data?.popularity >= 5 ? (
                <span>
      ...
      <div className="container" style={{ maxWidth: '90%' }}>
        <div className="searchbar">
          <div className="EventSlideHeaderText1">Venues All</div>
          <div
        ...
        <div>
          {searchTerm !== "" ? (
                  ...
                  >
                    ...
                    <div className="caption" style={{ padding: 10, height:'100%' }}>
                      ...
                      >
                        ...
                        {/* <p><i className="bi bi-star-fill"></i> {result.popularity}</p> */}
                        <p>{result.date}</p>
                        <p>{result.time}</p>
                        <p>
            ...
            <div>
              <div className="grid-container">
                {venueData.slice((currentPage - 1) * 12, currentPage * 12).map((event, index) => (
                  <div
                    key={index}
                    className="flex-item"
                    style={{
                  ...
                  >
                    <div
                      ...
                      onClick={() => {
                        ...
                        navigate(`/info_venues`, { state: { eventData: event } });
                      }}
                      style={{
                    ...
                    <div className="caption" style={{ padding: 10 }}>
                      ...
                      >
                        ...
                        {/* <p><i className="bi bi-star-fill"></i> {event.popularity}</p> */}
                        <p>{event.date}</p>
                        <p>{event.time}</p>
                        <p>
              ...
              <div className="container">
                <div className="pagination">
                  ...
                  <button 
                    onClick={() => setCurrentPage(currentPage + 1)} 
                    disabled={currentPage * 12 >= venueData.length}
                    className="pagination-button"
                  >
                    Next
                    {" "}
        ...
        {selectedEventData && <InfoVenues data={selectedEventData} onClose={() => setSelectedEventData(null)} />}
        {buyTicketPopupData && (
          <Popup
