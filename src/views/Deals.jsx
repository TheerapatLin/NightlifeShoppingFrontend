...
import InfoDeals from "./info_deals"
...
function Deals() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch('/data/data_deal.json');
        const data = await response.json();
        setdealData(data);
      } catch (error) {
        console.error('Error fetching data:', error);
  ...
  const handleSearch = () => {
    ...
    const results = dealData.filter((event) =>
  ...
  const handleGridContainerClick = (data) => {
    ...
    navigate(`/info_deals`, { state: { eventData: data } });
  };
  ...
  return (
    <div>
        <div className='container'  style={{ paddingTop: "70px", maxWidth: "90%"  }}>
          ...
          >
            <div className='EventSlideHeaderText1'>Poppular Deals</div>
            ...
            detailElement={(data, index) => (
              <div>
                ...
                <p className="item03" style={{ color: "#31ff64", padding: "0px 0px 0px 20px", fontSize: "12px" }}>
                  <i className="bi bi-calendar3"></i> {data?.validUntil ?? ""}
                </p>
                <p className="item03" style={{ color: "#31ff64", padding: "0px 0px 0px 20px", fontSize: "12px" }}>
                  <i className="bi bi-geo-alt-fill" style={{ fontStyle:'normal'}}>{data?.location}</i>
                </p>
                <p className="item03" style={{ color: "#31ff64", padding: "0px 0px 0px 20px", fontSize: "12px" }}>
                  <i className="bi bi-tag-fill"></i> {data?.tickets[0].price ?? ""}
                </p>
              </div>
            )}
        ...
        <div className="container" style={{ maxWidth: '90%' }}>
          <div className="searchbar">
            <div className="EventSlideHeaderText1">Deals All</div>
            <div
          ...
          <div>
            {searchTerm !== "" ? (
                    ...
                    >
                      <div
                        ...
                        onClick={() => {
                          ...
                          navigate(`/info_deals`, { state: { eventData: result } });
                        }}
                        style={{
                      ...
                      <div className="caption" style={{ padding: 10, height:'100%' }}>
                        <div
                          ...
                          onClick={() => {
                            handleGridContainerClick(result, index);
                            navigate(`/info_venues`, { state: { eventData: result } });
                          }}
                        >
                          ...
                          <p> 
                            <i className="bi bi-calendar3" style={{ fontStyle:'normal'}}>{" "}{result.validUntil}</i>
                          </p>
                          <p>
                            <i className="bi bi-tag-fill" style={{ fontStyle:'normal'}}>{" "}{result.tickets[0].price}</i>
                          </p>
                          <p>
                            <i className="bi bi-geo-alt-fill" style={{ fontStyle:'normal'}}>{result.location}</i>
                          </p>
                        </div>
                        <div
                          className="buyTicket"
              ...
              <div>
                <div className="grid-container">
                  {dealData.slice((currentPage - 1) * 12, currentPage * 12).map((event, index) => (
                    <div
                      key={index}
                      className="flex-item"
                      style={{
                    ...
                    >
                      <div
                        ...
                        onClick={() => {
                          ...
                          navigate(`/info_deals`, { state: { eventData: event } });
                        }}
                        style={{
                      ...
                      <div className="caption" style={{ padding: 10 }}>
                        ...
                        >
                          ...
                          <p> 
                            <i className="bi bi-calendar3" style={{ fontStyle:'normal'}}>{" "}{event.validUntil}</i>
                          </p>
                          <p>
                            <i className="bi bi-tag-fill" style={{ fontStyle:'normal'}}>{" "}{event.tickets[0].price}</i>
                          </p>
                          <p>
                            <i className="bi bi-geo-alt-fill" style={{ fontStyle:'normal'}}>{event.location}</i>
                          </p>
                        </div>
                        <div
                          className="buyTicket"
                ...
                <div className="container">
                  <div className="pagination">
                    ...
                    <button 
                      onClick={() => setCurrentPage(currentPage + 1)} 
                      disabled={currentPage * 12 >= dealData.length}
                      className="pagination-button"
                    >
                      Next
                      {" "}
          ...
          {selectedEventData && <InfoDeals data={selectedEventData} onClose={() => setSelectedEventData(null)} />}
          {buyTicketPopupData && (
            <Popup
