...
const EventSlider = (
    ...
    return (
        <div className='container eventslide' style={{ maxWidth: maxWidth, width: '100%', padding: '0px' }} >
            <div style={{
                ...
                <div id='cardDiv' ref={elementRef}
                    style={{
                        ...
                        transform: `translateX(${-(currentEvent + 1) * (cardWidth + cardMargin * 2)}px)`
                    }}>
                    {extendedArray.map((event, index) => (
                        <div
                            ...
                            style={{
                                ...
                                overflow: "hidden", width: cardWidth, marginInline: cardMargin,
                                boxShadow: cardShadow, flexShrink: 0, borderRadius: cardBorderRadius,
                                transform: `translateX(${(currentEvent - 1 - desiredLength / 2) * (cardWidth + cardMargin * 2)}px)`
                            }}>
                            <div style={{
                                width: '100%', height: imageHeight, backgroundColor: 'blue',
                                backgroundImage: `url(${event?.imageUrl})`, backgroundSize: 'cover'
                            }} />
