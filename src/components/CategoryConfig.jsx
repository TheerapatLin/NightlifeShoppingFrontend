                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span
                                                    className={`text-sm px-2 py-1 rounded ${category.status === "active" ? "bg-green-100 text-green-800" : category.status === "inactive" ? "bg-red-100 text-red-800" : "bg-gray-100 text-gray-800"}`}
                                                >
