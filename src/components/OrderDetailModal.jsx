                    ...
                    {!loading && !error && order && (
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="text-sm break-all">{order._id}</div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm">{order.originalPrice} THB</div>
                                </div>
                                <div>
                                    <div className="text-xs text-gray-500">Paid At</div>
                                    <div className="text-sm">{order.paidAt || '-'}</div>
                                </div>
                                <div>
                                    <div className="text-xs text-gray-500">Created At</div>
                                    <div className="text-sm">{order.createdAt || order.createAt || '-'}</div>
                                </div>
                                <div>
                                    <div className="text-xs text-gray-500">Updated At</div>
                                    <div className="text-sm">{order.updatedAt || order.updateAt || '-'}</div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <div>{order.paymentMetadata.brand || '-'}</div>
                                        </div>
                                        <div>
                                                ...
                                                {order.items.map((it, idx) => {
                                                    ...
                                                    return (
                                                        <tr key={idx} className="border-b">
                                                            <td className="px-3 py-2">{productTitle}</td>
