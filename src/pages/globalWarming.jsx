...
function GlobalWarming() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`/data/banners_globalwarming.json`);
  ...
  return (
    <div style={{ position: "relative", display: "flex", justifyContent: "center", padding: "0px", margin: "0px" }}>
      <div
        ...
        <center>
          ...
          >
            ...
            {windowSize.width >= 600 ? (
              ...
              >
                <img src="img/banner1.jpg" style={{ width: "100%", borderRadius: "20px" }} />
              </div>
            ) : (
              <div style={{ width: "100%", paddingTop: "50px", maxWidth: "1280px" }}>
                <img
                  src="img/banner1_m.jpg"
